...
/// scope.
/// </summary>
internal static class StoryDialogTreeEvidence
{
    ...
    public static Dictionary<string, JsonArray> Recover(IEnumerable<StoryTimelineRecord> input)
    {
        ...
        foreach (StoryTimelineRecord record in input)
        {
    ...
    private static ParsedTree ParseTree(StoryTimelineRecord record, JsonObject tree)
    {
